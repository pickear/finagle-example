 ...
 * @date 2016/7/19.
 */
public class SafeFinagleThriftServerThree extends BaseFinagleThrift{

    private final static Logger log = LoggerFactory.getLogger(SafeFinagleThriftServerThree.class);
    ...
    public static void main(String[] args) throws Group.JoinException, InterruptedException {
        ...
        FinagleThriftServiceRegister.register("finagle_service_three",new HelloInterfaceImplThree(local + ":" + port));
